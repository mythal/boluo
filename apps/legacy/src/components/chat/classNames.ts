...
export const chatItemContainerClassName =
  "group/chat-item relative grid grid-cols-[1.5rem_auto_1fr] grid-rows-[auto_auto] [grid-template-areas:'handle_name_.'_'handle_content_content'] gap-x-2 gap-y-0 bg-legacy-chat-item-background px-2 py-1 hover:bg-legacy-chat-item-hover data-[in-game=true]:text-[1rem] data-[in-game=false]:bg-legacy-chat-item-out-background data-[in-game=false]:text-[0.875rem] data-[in-game=false]:hover:bg-legacy-chat-item-out-hover data-[no-name=true]:grid-rows-[auto] data-[no-name=true]:[grid-template-areas:'handle_content_content'] [&_.handle]:opacity-30 hover:[&_.handle]:opacity-100 [&_.show-on-hover]:invisible hover:[&_.show-on-hover]:visible";
