    ...
    },
    {
      ...
      rules: [
        ...
        alertRule(datasourceUid, resources, {
          ...
          expression: `min(boluo_server_db_pool_connections_idle{app="${SERVER_APP}"})`,
          comparator: 'lt',
          threshold: 1,
          forDuration: '2m',
          severity: 'critical',
          summary: 'The application database pool has no idle connections.',
        }),
        alertRule(datasourceUid, resources, {
          uid: 'cesxl3kmvyznkd',
    ...
    },
    {
      ...
      rules: [
        alertRule(datasourceUid, errors, {
          ...
          expression: `sum(rate(fly_app_http_responses_count{app="${SERVER_APP}",status=~"5.."}[5m]))`,
          comparator: 'gt',
          threshold: 0.1,
          forDuration: '5m',
          severity: 'warning',
