...
export const useErrorExplain = () => {
  ...
  const defaultMessage = useMemo(
    () => intl.formatMessage({ defaultMessage: 'Something going wrong.' }),
    [intl],
  );
  const apiErrorMap = useMemo(
    () =>
      ({
        ...
        VALIDATION_FAIL: intl.formatMessage({
