...
export const Sidebar = React.memo<Props>(({ my, open }) => {
  ...
  return (
    <div className="w-48 fixed z-30 pb-2 md:static md:flex-0-auto bg-gray-200 md:h-full md:overflow-y-scroll border-r border-b md:border-b-0 shadow-lg md:shadow-none">
      <ul>{spaceList}</ul>
